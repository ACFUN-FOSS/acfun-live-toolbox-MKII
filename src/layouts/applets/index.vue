...
import { setTop, minimize, close, openConsole, loadApplet, saveApplet, loadConfig } from "@front/util_function/system";
...
export default defineComponent({
	...
	mounted() {
		...
		loadComponent(path).then((res) => {
			...
			let obsLink = "";
			if (config.obsPath) {
				obsLink = `${window.location.origin}/obs/applets/?name=${name}&path=${encodeURIComponent(config.obsPath)}`;
			}
