			...
			try {
				const res = await this.socket.call("SetStreamServiceSettings", {
					...
					streamServiceSettings: {
						bwtest: false,
						key: "kszt_oH5TrPqvwMk?sign=c641817b-d0da45db17dc85af3f348d3f41493ee6&ks_fix_ts&ks_ctx=dHRwOlBVTEw7dGZiOjE7cGR0OktVQUlTSE9VO3Zlcjo3ODg7cGR5OjA7dnF0OlVOS05PV047aXNWOmZhbHNlO2FpZDoyMTQ4NDQ7Y2lkOlRISVJEX1VQREFURV9UU0M%3D",
