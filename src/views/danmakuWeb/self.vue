...
export default defineComponent({
	...
	computed: {
		...
		...mapState(["userSession", "danmakuProfile", "danmakuSession", "roomProfile", "streamStatus", "rank"]),
		url() {
	...
	methods: {
		...
		async chechEveryThing() {
			...
			if (this.roomProfile.liveID && !["danmakuing", "streaming"].includes(this.streamStatus.step)) {
