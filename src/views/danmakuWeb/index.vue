...
export default defineComponent({
	...
	computed: {
		...
		...mapState(["userSession", "danmakuProfile", "danmakuSession", "roomProfile", "streamStatus"]),
		flow() {
						...
						data: {
							danmuInfo: {
								...
								userInfo: {
									...
									avatar: "https://tx-free-imgs.acfun.cn/FllI0yyjNgQ61QdJJdbIh9cRQIYY?imageMogr2/auto-orient/format/webp/quality/75!/ignore-error/1",
									medal: {
										uperID: 23682490,
										userID: 1,
										clubName: "ACER",
		...
		updateSettings() {
			...
			fetch("/configFiles/config.json", {
				...
				.then((json: any) => {
					...
					this.$store.state.danmakuProfile.common = json.common || commonSettings();
